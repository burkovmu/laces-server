          ...
          <div className={style.about_center}>
            <div className={style.about_btn_container}>
              ...
              <button className={style.about_btn}>
                {" "}
                <a href="https://repino.club" target="_blank">
                  repino.club{" "}
            ...
            <div className={style.about_text}>
              <p>
                ...
                таунхаусы и дуплексы на срок от 1 месяца и наслаждаться отдыхом на
                закрытой территории с инфраструктурой кантри-клаба.{" "}
              </p>
            </div>
          </div>
          <div className={style.flex_container}>
            ...
            <div className={style.flex_container_1}>
              ...
              <div className={style.flex_img_md}>
                <img
                  className={style.mobile_1_2}
                  src="/projects/flex_1_2.png"
                />
              </div>
            ...
            <div className={style.flex_container_2}>
              ...
              <div className={style.flex_img_md}>
                <img
                  className={style.mobile_2_2}
                  src="/projects/flex_2_2.png"
                />
              </div>
            ...
            <div className={style.flex_container_3}>
              ...
              <div className={style.flex_img_md}>
                <img
                  className={style.mobile_3_2}
                  src="/projects/flex_3_2.png"
                />
              </div>
              ...
              <div className="col">
                <div className={style.container_img}>
                  <img
                    ...
                    src="/mob_pic/mob_pic_1_1.png"
                  />
                </div>
                <div className={style.container_img}>
                  <img
                    className={style.mobile}
                    src="/mob_pic/mob_pic_1_2.png"
                  />
                </div>
                <div className={style.container_img}>
                  <img
                    className={style.mobile}
                    src="/mob_pic/mob_pic_1_3.png"
                  />
                </div>
              </div>
              <div className="col">
                <div className={style.container_img}>
                  <img
                    className={style.mobile}
                    src="/mob_pic/mob_pic_2_1.png"
                  />
                </div>
                <div className={style.container_img}>
                  <img
                    className={style.mobile}
                    src="/mob_pic/mob_pic_2_2.png"
                  />
                </div>
                <div className={style.container_img}>
                  <img
                    className={style.mobile}
                    src="/mob_pic/mob_pic_2_3.png"
                  />
                </div>
              </div>
            </div>
